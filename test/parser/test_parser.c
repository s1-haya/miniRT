...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/wrong_identifier.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/wrong_value.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/multi_identifier_and_acl.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/more_param_size_in_light.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/more_param_size_in_ambient.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/more_param_size_in_camera.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/more_param_size_in_plane.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/more_param_size_in_sphere.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
...
// 	data.data = 0;
// 	scene = new_scene(NULL, NULL, camera, data);
// 	parser(&scene, "./ft_file/error/more_param_size_in_cylinder.rt", &result);
// 	TEST_ASSERT_FALSE(result);
// }
